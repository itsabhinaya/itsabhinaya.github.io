      ...
      .attr("data-foo", function(d) {
        ...
        if ( smallStateIndex > -1) {
          ...
          layer.append("text")
              .attr("x", x)
              .attr("y", y)
              .style("font-size", (options.fontSize || 15) + 'px')
